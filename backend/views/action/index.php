...
<head>
    <meta charset="utf-8">
    <title>控制器管理 - <?=Yii::$app->params['admin_web_name']?></title>
...
<form class="layui-form">
    <blockquote class="layui-elem-quote quoteBox">
        <form class="layui-form">
            ...
            <div class="layui-inline">
                <a class="layui-btn layui-btn-normal addNews_btn">添加控制器</a>
            </div>
            <div class="layui-inline">
...
<script type="text/javascript" src="<?=Yii::$app->params['admin_web_url']?>/assets/js/layui/action.js"></script>
</body>
</html>