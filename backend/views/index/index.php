...
<head>
    <meta charset="utf-8">
    <title>后台管理 - 6789 Network Technology Co. Ltd.</title>
    ...
    <link rel="stylesheet" href="<?=Yii::$app->params['admin_web_url']?>/layui/css/index.css" media="all" />
</head>
...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-header header">
        <div class="layui-main mag0">
            <a href="#" class="logo">6789NETWORK.</a>
            <!-- 显示/隐藏菜单 -->
            ...
            <ul class="layui-nav top_menu">
                ...
                <li class="layui-nav-item" id="userInfo">
                    <a href="javascript:;"><img src="<?=Yii::$app->params['admin_web_url']?>/layui/images/face.jpg" class="layui-nav-img userAvatar" width="35" height="35"><cite class="adminName">管理员</cite></a>
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" data-url="<?=Yii::$app->params['admin_web_url']?>/layui/page/user/userInfo.html"><i class="seraph icon-ziliao" data-icon="icon-ziliao"></i><cite>个人资料</cite></a></dd>
                        <dd><a href="javascript:;" data-url="<?=Yii::$app->params['admin_web_url']?>/layui/page/user/changePwd.html"><i class="seraph icon-xiugai" data-icon="icon-xiugai"></i><cite>修改密码</cite></a></dd>
                        <dd><a href="javascript:;" class="showNotice"><i class="layui-icon">&#xe645;</i><cite>系统公告</cite><span class="layui-badge-dot"></span></a></dd>
                        <dd pc><a href="javascript:;" class="functionSetting"><i class="layui-icon">&#xe620;</i><cite>功能设定</cite><span class="layui-badge-dot"></span></a></dd>
                        <dd pc><a href="javascript:;" class="changeSkin"><i class="layui-icon">&#xe61b;</i><cite>更换皮肤</cite></a></dd>
                        <dd><a href="/index/logout" class="signOut"><i class="seraph icon-tuichu"></i><cite>退出</cite></a></dd>
                    </dl>
                </li>
            </ul>
        </div>
    ...
    <div class="layui-side layui-bg-black">
        <div class="user-photo">
            <a class="img" title="我的头像" ><img src="<?=Yii::$app->params['admin_web_url']?>/layui/images/face.jpg" class="userAvatar"></a>
        ...
        <div class="navBar layui-side-scroll" id="navBar">
            <ul class="layui-nav layui-nav-tree">
                <li class="layui-nav-item layui-this">
                    <a href="javascript:;" data-url="<?=Yii::$app->params['admin_web_url']?>/layui/page/main.html"><i class="layui-icon" data-icon=""></i><cite>后台首页</cite></a>
                </li>
            </ul>
        </div>
    </div>
        ...
        <div class="layui-tab mag0" lay-filter="bodyTab" id="top_tabs_box">
            ...
            <div class="layui-tab-content clildFrame">
                <div class="layui-tab-item layui-show">
                    <iframe src="<?=Yii::$app->params['admin_web_url']?>/layui/page/main.html"></iframe>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="layui-footer footer">
        <p><span>  成都陆柒捌玖网络科技有限公司 Chengdu 6789 Network Technology Co. Ltd.  copyright @6789.cd</span></p>
    </div>
</div>
...
<script type="text/javascript" src="<?=Yii::$app->params['admin_web_url']?>/layui/js/index.js"></script>
